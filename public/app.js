...
const TRANSLATIONS = {
    ...
    'auth-support-phone-label': { ar: 'تواصل عبر الهاتف:', en: 'Call:' },
    'auth-support-email-label': { ar: 'البريد الإلكتروني:', en: 'Email:' },
...
function renderAuthModalHTML() {
    ...
    if (!authOverlay || authOverlay.children.length > 0) return;

    authOverlay.innerHTML = `
        <!-- Form 1: Login -->
        <div class="locker-modal auth-form-container" id="login-form-box">
            <div class="auth-top-bar" style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-bottom: 36px; direction: ltr; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.06); border-radius: 12px; padding: 10px 14px; box-sizing: border-box;">
                <div class="auth-brand-logo" style="display: flex; align-items: center; gap: 10px; direction: ltr; text-align: left;">
                    <img src="logo.png" alt="Qirat" style="height: 38px; width: auto; flex-shrink: 0;">
                    <div class="auth-brand-text" style="display: flex; flex-direction: column; align-items: flex-start; text-align: left;">
                        <span style="font-size: 20px; font-weight: 800; color: var(--text-primary); line-height: 1.1; font-family: 'Tajawal', sans-serif;" data-i18n="auth-brand-title">قيراط</span>
                        <span style="font-size: 9px; color: var(--text-secondary); margin-top: 2px; font-family: 'Tajawal', sans-serif; font-weight: 500;" data-i18n="auth-brand-subtitle">المستشار الفني والادخاري للذهب</span>
                    </div>
                </div>
                <button class="btn-auth-lang-toggle-btn" style="background: rgba(255, 255, 255, 0.05); border: 1px solid var(--border-color); color: #FFF; padding: 6px 12px; border-radius: var(--radius-sm); cursor: pointer; font-weight: 700; font-size: 11px; font-family: 'Tajawal', sans-serif; transition: var(--transition-smooth);">EN</button>
            </div>
            <h3 data-i18n="auth-login-title" style="margin-top: 10px;">تسجيل الدخول لموقع قيراط</h3>
            <p data-i18n="auth-login-desc">أدخل بياناتك للوصول ومزامنة محفظتك الذهبية سحابياً.</p>
            
            <form id="auth-login-form" class="inputs-layout" style="text-align: left; width: 100%; margin-top: 10px;" autocomplete="off">
                <div class="input-group">
                    <label for="login-phone" data-i18n="auth-phone-label">رقم الهاتف</label>
                    <input type="text" id="login-phone" placeholder="مثال: 01050442007" data-i18n-placeholder="auth-phone-placeholder" autocomplete="off" required>
                </div>
                <div class="input-group">
                    <label for="login-password" data-i18n="auth-password-label">كلمة المرور</label>
                    <input type="text" id="login-password" placeholder="أدخل كلمة المرور" data-i18n-placeholder="auth-password-placeholder" autocomplete="off" style="-webkit-text-security: disc; -moz-text-security: disc; text-security: disc;" required>
                </div>
                <div style="text-align: left; margin-top: -5px; margin-bottom: 10px;">
                    <a href="#" onclick="toggleAuthForms(event, 'forgot')" class="text-xs text-muted" style="text-decoration: none; font-size: 11px;" data-i18n="auth-forgot-link">نسيت كلمة السر؟</a>
                </div>
                
                <button type="submit" class="btn-primary" style="margin-top: 15px; width: 100%;">
                    <span data-i18n="auth-login-btn">تسجيل الدخول</span> <i data-lucide="check"></i>
                </button>
                <button type="button" id="btn-login-guest" class="btn-secondary" style="margin-top: 10px; width: 100%;">
                    <span data-i18n="auth-guest-btn">الدخول كـ زائر (بدون حساب)</span> <i data-lucide="user"></i>
                </button>
            </form>
            
            <div class="auth-toggle-link" style="margin-top: 20px; font-size: 11px;">
                <span class="text-muted" data-i18n="auth-no-account-span">ليس لديك حساب؟</span> 
                <a href="#" onclick="toggleAuthForms(event, 'register')" class="gold-text font-bold" style="text-decoration: underline;" data-i18n="auth-register-link">إنشاء حساب جديد</a>
            </div>
        </div>

        <!-- Form 2: Register -->
        <div class="locker-modal auth-form-container" id="register-form-box" style="display: none;">
            <div class="auth-top-bar" style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-bottom: 36px; direction: ltr; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.06); border-radius: 12px; padding: 10px 14px; box-sizing: border-box;">
                <div class="auth-brand-logo" style="display: flex; align-items: center; gap: 10px; direction: ltr; text-align: left;">
                    <img src="logo.png" alt="Qirat" style="height: 38px; width: auto; flex-shrink: 0;">
                    <div class="auth-brand-text" style="display: flex; flex-direction: column; align-items: flex-start; text-align: left;">
                        <span style="font-size: 20px; font-weight: 800; color: #FFF; line-height: 1.1; font-family: 'Tajawal', sans-serif;" data-i18n="auth-brand-title">قيراط</span>
                        <span style="font-size: 9px; color: var(--text-secondary); margin-top: 2px; font-family: 'Tajawal', sans-serif; font-weight: 500;" data-i18n="auth-brand-subtitle">المستشار الفني والادخاري للذهب</span>
                    </div>
                </div>
                <button class="btn-auth-lang-toggle-btn" style="background: rgba(255, 255, 255, 0.05); border: 1px solid var(--border-color); color: #FFF; padding: 6px 12px; border-radius: var(--radius-sm); cursor: pointer; font-weight: 700; font-size: 11px; font-family: 'Tajawal', sans-serif; transition: var(--transition-smooth);">EN</button>
            </div>
            <h3 data-i18n="auth-reg-title" style="margin-top: 10px;">إنشاء حساب استثماري جديد</h3>
            <p data-i18n="auth-reg-desc">سجل حسابك لحفظ ممتلكاتك ومزامنتها بأمان.</p>
            
            <form id="auth-register-form" class="inputs-layout" style="text-align: left; width: 100%; margin-top: 10px;">
                <div class="input-group">
                    <label for="reg-name" data-i18n="auth-fullname-label">الاسم بالكامل</label>
                    <input type="text" id="reg-name" placeholder="مثال: عمر عادل" data-i18n-placeholder="auth-fullname-placeholder" autocomplete="off" required>
                </div>
                <div class="input-group">
                    <label for="reg-phone" data-i18n="auth-phone-label">رقم الهاتف</label>
                    <input type="text" id="reg-phone" placeholder="يتكون من 11 رقماً" data-i18n-placeholder="auth-phone-reg-placeholder" autocomplete="off" required>
                </div>
                <div class="input-group">
                    <label for="reg-email" data-i18n="auth-email-label">البريد الإلكتروني</label>
                    <input type="email" id="reg-email" placeholder="مثال: user@example.com" data-i18n-placeholder="auth-email-placeholder" autocomplete="off" required>
                </div>
                <div class="input-group">
                    <label for="reg-password" data-i18n="auth-password-label">كلمة المرور</label>
                    <input type="text" id="reg-password" placeholder="6 أحرف أو أرقام كحد أدنى" data-i18n-placeholder="auth-password-reg-placeholder" autocomplete="off" style="-webkit-text-security: disc; -moz-text-security: disc; text-security: disc;" required>
                </div>
                
                <div style="display: flex; align-items: flex-start; gap: 8px; margin-top: 10px; font-size: 11px;">
                    <input type="checkbox" id="reg-consent" required style="width: auto; margin-top: 2px;">
                    <label for="reg-consent" class="text-muted" style="line-height: 1.4; cursor: pointer;">
                        <span data-i18n="auth-consent-text-part1">أوافق على معالجة بريدي الإلكتروني ورقم هاتفي لتأمين الحساب واستعادة كلمة المرور طبقاً لـ</span> <a href="#" id="link-open-privacy-policy" class="gold-text font-bold" style="text-decoration: underline;" data-i18n="auth-consent-link">سياسة الخصوصية</a>.
                    </label>
                </div>
                
                <button type="submit" class="btn-primary" style="margin-top: 15px; width: 100%;">
                    <span data-i18n="auth-confirm-reg-btn">تأكيد وإنشاء الحساب</span> <i data-lucide="shield-check"></i>
                </button>
            </form>
            
            <div class="auth-toggle-link" style="margin-top: 20px; font-size: 11px;">
                <span class="text-muted" data-i18n="auth-already-have-account-span">لديك حساب بالفعل؟</span> 
                <a href="#" onclick="toggleAuthForms(event, 'login')" class="gold-text font-bold" style="text-decoration: underline;" data-i18n="auth-login-btn">تسجيل الدخول</a>
            </div>
        </div>

        <!-- Form 3: Forgot Password -->
        <div class="locker-modal auth-form-container" id="forgot-form-box" style="display: none;">
            <div class="auth-top-bar" style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-bottom: 36px; direction: ltr; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.06); border-radius: 12px; padding: 10px 14px; box-sizing: border-box;">
                <div class="auth-brand-logo" style="display: flex; align-items: center; gap: 10px; direction: ltr; text-align: left;">
                    <img src="logo.png" alt="Qirat" style="height: 38px; width: auto; flex-shrink: 0;">
                    <div class="auth-brand-text" style="display: flex; flex-direction: column; align-items: flex-start; text-align: left;">
            ...
            <h3 data-i18n="auth-forgot-title" style="margin-top: 10px;">استعادة كلمة المرور</h3>
            <p data-i18n="auth-forgot-desc">أدخل البيانات المطلوبة بدقة لتأكيد هويتك وتعيين كلمة مرور جديدة.</p>
            
            <form id="auth-forgot-form" class="inputs-layout" style="text-align: left; width: 100%; margin-top: 10px;">
                <!-- Step 1 Fields -->
                <div id="forgot-step-1-fields">
                    <div class="input-group">
                        <label for="forgot-phone" data-i18n="auth-forgot-phone-label">رقم الهاتف المسجل</label>
                        <input type="text" id="forgot-phone" placeholder="مثال: 01050442007" data-i18n-placeholder="auth-phone-placeholder" autocomplete="off" required>
                    </div>
                    <div class="input-group" style="margin-top: 10px;">
                        <label for="forgot-email" data-i18n="auth-email-label">البريد الإلكتروني المسجل</label>
                        <input type="email" id="forgot-email" placeholder="مثال: user@example.com" data-i18n-placeholder="auth-email-placeholder" autocomplete="off" required>
                    </div>
                    <button type="button" id="btn-forgot-send-otp" class="btn-primary" style="margin-top: 15px; width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px;">
                        <span data-i18n="auth-send-otp-btn">إرسال كود التحقق</span> <i data-lucide="send"></i>
                    </button>
                </div>
                
                <!-- Step 2 Fields (Hidden Initially) -->
                <div id="forgot-step-2-fields" style="display: none;">
                    <div class="input-group">
                        <label for="forgot-otp" data-i18n="auth-otp-label">كود التحقق (OTP)</label>
                        <input type="text" id="forgot-otp" placeholder="أدخل الكود المكون من 6 أرقام" data-i18n-placeholder="auth-otp-placeholder" maxlength="6" autocomplete="off">
                    </div>
                    <div class="input-group" style="margin-top: 10px;">
                        <label for="forgot-new-password" data-i18n="auth-forgot-newpw-label">كلمة المرور الجديدة</label>
                        <input type="text" id="forgot-new-password" placeholder="كلمة المرور الجديدة (6 أحرف/أرقام كحد أدنى)" data-i18n-placeholder="auth-forgot-newpw-placeholder" autocomplete="off" style="-webkit-text-security: disc; -moz-text-security: disc; text-security: disc;">
                    </div>
                    <button type="submit" id="btn-forgot-submit" class="btn-primary" style="margin-top: 15px; width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px;">
                        <span data-i18n="auth-forgot-submit-btn">تحديث كلمة المرور والدخول</span> <i data-lucide="check-check"></i>
                    </button>
                </div>
            </form>
            
            <button class="btn-secondary" id="btn-show-support-info" style="margin-top: 10px; width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px;">
                <span data-i18n="auth-support-btn">نسيت تفاصيل المحفظة؟ تواصل مع الدعم</span> <i data-lucide="help-circle"></i>
            </button>
            
            <div id="support-info-box" style="display: none; margin-top: 15px; padding: 12px; border: 1px dashed var(--border-color); border-radius: var(--radius-sm); background: var(--bg-dark); font-size: 11px; text-align: start; line-height: 1.6;">
                <div style="font-weight: 700; color: var(--gold-primary); margin-bottom: 6px;" data-i18n="auth-support-title">مركز الدعم الفني والمساعدة المباشرة:</div>
                <div>📞 <span data-i18n="auth-support-phone-label">تواصل عبر الهاتف:</span> <a href="tel:01050442007" class="gold-text font-bold" style="text-decoration: underline;">01050442007</a></div>
                <div style="margin-top: 6px;">✉️ <span data-i18n="auth-support-email-label">البريد الإلكتروني:</span> <a href="mailto:qirat.admin@gmail.com" class="gold-text font-bold" style="text-decoration: underline;">qirat.admin@gmail.com</a></div>
                <div style="margin-top: 8px; color: var(--text-secondary);" data-i18n="auth-support-desc">تواصل مع الدعم لمساعدتك في إعادة تعيين كلمة مرورك يدوياً.</div>
            </div>
            
            <div class="auth-toggle-link" style="margin-top: 20px; font-size: 11px;">
                <a href="#" onclick="toggleAuthForms(event, 'login')" class="gold-text font-bold" style="text-decoration: underline;" data-i18n="auth-back-to-login">العودة لتسجيل الدخول</a>
            </div>
        </div>
    `;
...
async function checkAuthStatus() {
    ...
    if (authOverlay) {
        ...
        authOverlay.innerHTML = ''; // Keep DOM 100% clean of auth form inputs!
    }
